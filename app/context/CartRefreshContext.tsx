...
const CartRefreshContext = createContext<CartRefreshContextType>({ cartRefreshTrigger: 0, setCartRefreshTrigger: () => {} });

export function CartRefreshProvider({ children }: CartRefreshProviderProps) {
  const [cartRefreshTrigger, setCartRefreshTrigger] = useState(0);

  return (
    <CartRefreshContext.Provider value={{ cartRefreshTrigger, setCartRefreshTrigger }}>
      {children}
